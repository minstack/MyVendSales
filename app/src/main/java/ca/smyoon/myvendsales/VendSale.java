...
public class VendSale {
    ...
    public String getReturn_for() {
        return return_for;
    }

    public void setReturn_for(String return_for) {
        this.return_for = return_for;
    }
    ...
    public double getTotal_loyalty() {
        return total_loyalty;
    }

    public void setTotal_loyalty(double total_loyalty) {
